namespace System.Linq.V2
{
    ...
    public sealed partial class V2EnumerableUnitTests
    {
        ...
        private sealed class MockFirstOrDefaultWithPredicateAndDefaultMixinWithoutOverloadAndMonadWhereSourceIsNotMixin : IFirstOrDefaultableMixin<object>, IEnumerableMonad<object>
        {
            ...
            public IV2Enumerable<object> Source { get; } = Enumerable.Repeat(MockFirstOrDefaultWithPredicateAndDefaultMixinWithoutOverloadAndMonadWhereSourceIsNotMixin.Element, 1).ToV2Enumerable();
