...
*/
        ...
        private sealed class MockFirstOrDefaultWithPredicateMixinWithoutOverloadAndMonadWhereSourceIsNotMixin : IFirstOrDefaultableMixin<object>, IEnumerableMonad<object>
        {
            ...
            public IV2Enumerable<object> Source { get; } = Enumerable.Repeat(MockFirstOrDefaultWithPredicateMixinWithoutOverloadAndMonadWhereSourceIsNotMixin.Element, 1).ToV2Enumerable();
