namespace Microsoft.CodeAnalysis.Diagnostics
{
    ...
    public abstract class BaseLowercaseTypeNameAnalyzer : DiagnosticAnalyzer
    {
        ...
        private static readonly DiagnosticDescriptor Rule = new DiagnosticDescriptor(FxDiagnosticIds.BaseLowercaseTypeNameAnalyzerDiagnosticId, Title, MessageFormat, Category, DiagnosticSeverity.Warning, isEnabledByDefault: true, description: Description);
